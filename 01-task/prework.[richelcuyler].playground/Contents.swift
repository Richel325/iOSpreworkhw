...
if age >= 21 {
    ...
    canDrink == false
    print("Not old enough to drink, but you can vote and drive!")
} else if age < 18 && age >= 16 {
    canDrink == false
    canVote == false
    print("Not old enough to drink or vote, but you can drive!")
} else if age < 16 {
    canDrink == false
    canVote == false
    canDrive == false
    print("Not old enought drive, vote, or drink!")
}
...
var uppercaseMultilingual = multilingual.uppercaseString
